...
import CalcNavigator from './navigation/TabNavigationCalculator'; 
import MenuButton1 from './components/MenuButton1'; 
const AppIndex = createAppContainer(CalcNavigator)  
        ...
        return(  
            <View style={{flex:1}} >  
                ...
                <Text style={{marginLeft: 100,fontWeight: 'bold',
                 fontSize:24, marginTop:10, color: 'white',textAlign: 'center'}}> 
                 Tax Calculators 
                 </Text>
